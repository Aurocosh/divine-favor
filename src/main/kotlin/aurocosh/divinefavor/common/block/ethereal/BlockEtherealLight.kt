...
open class BlockEtherealLight(name: String, material: Material, lightLevel: Int) : ModBlockAir(name, material, ConstMainTabOrder.OTHER_BLOCKS), ICustomStateMappedBlock {
    init {
        tickRandomly = true
