...
class WallCoordinateGenerator : CachedCoordinateGenerator() {
    fun getCoordinates(playerFacing: EnumFacing, blockPos: BlockPos, up: Int, down: Int, left: Int, rigth: Int, count: Int): List<BlockPos> {
        if (isCached(playerFacing, blockPos, up, down, left, rigth))
