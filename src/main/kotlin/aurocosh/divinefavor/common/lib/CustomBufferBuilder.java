 ...
 * are compared in reverse order in {@link CustomBufferBuilder#sortVertexData sortVertexData}
 */

@SideOnly(Side.CLIENT)
public class CustomBufferBuilder extends BufferBuilder {
    ...
    public void sortVertexData(float cameraX, float cameraY, float cameraZ) {
        ...
        Arrays.sort(ainteger, (p_compare_1_, p_compare_2_) -> Floats.compare(afloat[p_compare_1_], afloat[p_compare_2_]));
    ...
    public void setVertexState(net.minecraft.client.renderer.BufferBuilder.State state) {
    ...
    @NotNull
    public net.minecraft.client.renderer.BufferBuilder tex(double u, double v) {
    ...
    @NotNull
    public net.minecraft.client.renderer.BufferBuilder lightmap(int skyLight, int blockLight) {
        int i = this.vertexCount * this.vertexFormat.getSize() + this.vertexFormat.getOffset(this.vertexFormatIndex);
    ...
    @NotNull
    public net.minecraft.client.renderer.BufferBuilder color(float red, float green, float blue, float alpha) {
        return this.color((int) (red * 255.0F), (int) (green * 255.0F), (int) (blue * 255.0F), (int) (alpha * 255.0F));
    }

    @NotNull
    public net.minecraft.client.renderer.BufferBuilder color(int red, int green, int blue, int alpha) {
        if (this.noColor) {
            return this;
        }
        else {
    ...
    @NotNull
    public net.minecraft.client.renderer.BufferBuilder pos(double x, double y, double z) {
        int i = this.vertexCount * this.vertexFormat.getSize() + this.vertexFormat.getOffset(this.vertexFormatIndex);
    ...
    @NotNull
    public net.minecraft.client.renderer.BufferBuilder normal(float x, float y, float z) {
        int i = this.vertexCount * this.vertexFormat.getSize() + this.vertexFormat.getOffset(this.vertexFormatIndex);
