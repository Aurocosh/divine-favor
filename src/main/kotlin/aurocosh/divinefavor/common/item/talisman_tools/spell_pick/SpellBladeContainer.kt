...
class SpellPickContainer(player: EntityPlayer, private val spellBladeHandler: ISpellPickHandler, private val hand: EnumHand) : GenericContainer(ItemSpellPick.SLOT_COUNT) {
