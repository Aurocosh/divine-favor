...
class SpellBowContainer(private val player: EntityPlayer, private val spellBowHandler: ISpellBowHandler, private val hand: EnumHand) : GenericContainer(ItemSpellBow.SIZE) {
