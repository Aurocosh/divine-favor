...
class SpellTalismanBuildBlockRelative(name: String, spirit: ModSpirit, favorCost: Int, options: EnumSet<SpellOptions>) : ItemSpellTalisman(name, spirit, favorCost, options) {
    ...
    private fun getCoordinates(context: TalismanContext): List<BlockPos> {
        ...
        return listOf(positionPropertyWrapper.getPositionRelative(context,length))
    }
}
