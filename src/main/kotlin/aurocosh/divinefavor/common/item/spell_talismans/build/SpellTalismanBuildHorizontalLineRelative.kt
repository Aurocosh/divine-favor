...
class SpellTalismanBuildHorizontalLineRelative(name: String, spirit: ModSpirit, favorCost: Int, options: EnumSet<SpellOptions>) : SpellTalismanBuildRelative(name, spirit, favorCost, options) {
    ...
    override fun getCoordinates(context: TalismanContext): List<BlockPos> {
        ...
        return coordinateGenerator.getCoordinates(directions, blockPos, 1, 0, left, right)
    }
