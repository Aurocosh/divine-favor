...
class StackPropertyFloat(name: String, defaultValue: Float, val minValue: Float, val maxValue: Float, showInTooltip: Boolean, orderIndex: Int, serverSync: (Int, StackProperty<Float>, Float) -> Unit) : StackProperty<Float>(name, defaultValue, showInTooltip, orderIndex, serverSync) {
