...
import aurocosh.divinefavor.common.stack_properties.generators.StackPropertyGenerator
...
open class StackPropertyHandler(private val parentName: String, private val propertyGenerator: StackPropertyGenerator = StackPropertyGenerator()) : IPropertyAccessor {
    ...
    fun registerStringProperty(name: String, defaultValue: String, showInTooltip: Boolean = false, showInGui: Boolean = true, orderIndex: Int = 0) =
            registerProperty(propertyGenerator.makeStringProperty(name, defaultValue, showInTooltip, showInGui, orderIndex))
