...
class StackPropertyEnumFacing(name: String, defaultValue: EnumFacing, showInTooltip: Boolean, serverSync: (StackProperty<EnumFacing>, EnumFacing) -> Unit) : StackProperty<EnumFacing>(name, defaultValue, showInTooltip, serverSync) {
