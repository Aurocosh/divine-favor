...
class StackPropertyBlockPos(name: String, defaultValue: BlockPos, showInTooltip: Boolean, orderIndex: Int, serverSync: (Int, StackProperty<BlockPos>, BlockPos) -> Unit) : StackProperty<BlockPos>(name, defaultValue, showInTooltip, orderIndex, serverSync) {
