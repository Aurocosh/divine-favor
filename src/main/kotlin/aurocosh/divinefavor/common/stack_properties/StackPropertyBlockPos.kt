...
class StackPropertyBlockPos(name: String, defaultValue: BlockPos, showInTooltip: Boolean, showInGui: Boolean, orderIndex: Int, serverSync: (Int, StackProperty<BlockPos>, BlockPos) -> Unit) : StackProperty<BlockPos>(name, defaultValue, showInTooltip, showInGui, orderIndex, serverSync) {
