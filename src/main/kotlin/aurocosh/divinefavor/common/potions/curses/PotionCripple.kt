...
class PotionCripple : ModPotion("cripple", 0x7FB8A4) {
    init {
        setIsCurse(true)
        registerPotionAttributeModifier(SharedMonsterAttributes.MOVEMENT_SPEED, "b171212d-7cd8-4a62-8665-b2258adf68b8", (-ConfigCurses.cripple.slownessForce).toDouble(), 2)
    }
