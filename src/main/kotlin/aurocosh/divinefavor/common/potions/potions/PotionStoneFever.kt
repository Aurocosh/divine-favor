...
class PotionStoneFever : ModPotion("stone_fever", 0x7FB8A4) {
    ...
    companion object {
        ...
        private fun punishPlayer(player: EntityPlayer) {
            ...
            player.addPotionEffect(ModEffect(MobEffects.SLOWNESS, ConfigSpell.stoneFever.slownessDuration).setIsCurse())
            player.addPotionEffect(ModEffect(MobEffects.BLINDNESS, ConfigSpell.stoneFever.blindnessDuration).setIsCurse())
            player.addPotionEffect(ModEffect(MobEffects.MINING_FATIGUE, ConfigSpell.stoneFever.fatigueDuration, ConfigSpell.stoneFever.fatigueLevel).setIsCurse())
        }
    }
}
