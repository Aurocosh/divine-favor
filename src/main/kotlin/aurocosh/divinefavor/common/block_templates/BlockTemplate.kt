...
class BlockTemplate(val uuid: UUID, val blockMapIntState: BlockMapIntState, val posIntArray: IntArray, val stateIntArray: IntArray, val boundingBox: CuboidBoundingBox, val dimension: Int, val creator: String, val orientation: FaceDiagonalOrientation = FaceDiagonalOrientation()) {
