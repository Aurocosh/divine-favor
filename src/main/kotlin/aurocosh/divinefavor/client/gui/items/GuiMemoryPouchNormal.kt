...
class GuiMemoryPouchNormal(player: EntityPlayer, internal var stack: ItemStack, hand: EnumHand)
    : GuiContainer(MemoryPouchTemplateContainer(player, stack.cap(CAPABILITY_MEMORY_POUCH), hand)) {
    ...
    companion object {
        val WIDTH = 175
        val HEIGHT = 165
        private val texture = ResourceLocation(ConstResources.GUI_MEMORY_POUCH_NORMAL)
    }
}
