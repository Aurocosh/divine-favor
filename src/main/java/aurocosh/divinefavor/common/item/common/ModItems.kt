...
object ModItems {
    ...
    fun preInit() {
        ...
        rope_barrier = object : ItemRope<EntityRopeBarrierNode>("rope_barrier", "ropes/barrier", EntityRopeBarrierNode::class.java, EntityRopeBarrierNode.ROPE_LENGTH) {}
        rope_explosive = object : ItemRope<EntityRopeExplosiveNode>("rope_explosive", "ropes/explosive", EntityRopeExplosiveNode::class.java, EntityRopeExplosiveNode.ROPE_LENGTH) {}
        rope_glowing = object : ItemRope<EntityRopeGlowingNode>("rope_glowing", "ropes/glowing", EntityRopeGlowingNode::class.java, EntityRopeGlowingNode.ROPE_LENGTH) {}
        rope_guide = object : ItemRope<EntityRopeGuideNode>("rope_guide", "ropes/guide", EntityRopeGuideNode::class.java, EntityRopeGuideNode.ROPE_LENGTH) {}
        rope_inert = object : ItemRope<EntityRopeInertNode>("rope_inert", "ropes/inert", EntityRopeInertNode::class.java, EntityRopeInertNode.ROPE_LENGTH) {}
        rope_teleporting = object : ItemRope<EntityRopeTeleportingNode>("rope_teleporting", "ropes/teleporting", EntityRopeTeleportingNode::class.java, EntityRopeTeleportingNode.ROPE_LENGTH) {
