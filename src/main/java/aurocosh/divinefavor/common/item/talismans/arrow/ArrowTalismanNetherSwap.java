...
public class ArrowTalismanNetherSwap extends ItemArrowTalisman {
    public ArrowTalismanNetherSwap(String name, ModSpirit spirit, int favorCost, int color, double arrowDamage, EnumSet<ArrowOptions> options, ArrowType arrowType) {
