...
public class ModArrowTalismans {
    ...
    public static void preInit() {
        ...
        blast_arrow = new ArrowTalismanExplosive("blast_arrow", ModSpirits.arbow, genericTier1, ArrowOptions.ARROW_BREAKS, ArrowType.WOODEN_ARROW, ConfigArrow.blastArrow);
        ...
        disarm = new ArrowTalismanDisarm("disarm", ModSpirits.arbow, ConfigArrow.disarm.favorCost, Color.orange, ConfigArrow.disarm.damage, ArrowOptions.REQUIRES_TARGET, ArrowType.WOODEN_ARROW);
        explosive_arrow = new ArrowTalismanExplosive("explosive_arrow", ModSpirits.arbow, genericTier2, ArrowOptions.ARROW_BREAKS, ArrowType.WOODEN_ARROW, ConfigArrow.explosiveArrow);
        ...
        hand_swap = new ArrowTalismanHandSwap("hand_swap", ModSpirits.arbow, ConfigArrow.handSwap.favorCost, Color.orange, ConfigArrow.handSwap.damage, ArrowOptions.REQUIRES_TARGET, ArrowType.WOODEN_ARROW);
        ...
        nuke_arrow = new ArrowTalismanExplosive("nuke_arrow", ModSpirits.arbow, genericTier3, ArrowOptions.ARROW_BREAKS, ArrowType.WOODEN_ARROW, ConfigArrow.nukeArrow);
        ...
        reinforced_arrow_1 = new ItemArrowTalisman("reinforced_arrow_1", ModSpirits.arbow, ConfigArrow.reinforcedArrow1.favorCost, genericTier1, ConfigArrow.reinforcedArrow1.damage, ArrowOptions.NORMAL, ArrowType.WOODEN_ARROW);
        reinforced_arrow_2 = new ItemArrowTalisman("reinforced_arrow_2", ModSpirits.arbow, ConfigArrow.reinforcedArrow2.favorCost, genericTier2, ConfigArrow.reinforcedArrow2.damage, ArrowOptions.NORMAL, ArrowType.WOODEN_ARROW);
        reinforced_arrow_3 = new ItemArrowTalisman("reinforced_arrow_3", ModSpirits.arbow, ConfigArrow.reinforcedArrow3.favorCost, genericTier3, ConfigArrow.reinforcedArrow3.damage, ArrowOptions.NORMAL, ArrowType.WOODEN_ARROW);
        ...
        stasis_arrow = new ArrowTalismanStasisArrow("stasis_arrow", ModSpirits.arbow, ConfigArrow.stasisArrow.favorCost, new Color(164, 163, 168), ConfigArrow.stasisArrow.damage, ArrowOptions.NORMAL, ArrowType.WOODEN_ARROW);
        ...
        vacuum_arrow = new ArrowTalismanVacuumArrow("vacuum_arrow", ModSpirits.arbow, ConfigArrow.vacuumArrow.favorCost,  new Color(83, 4, 124), ConfigArrow.vacuumArrow.damage, ArrowOptions.NORMAL, ArrowType.WOODEN_ARROW);
