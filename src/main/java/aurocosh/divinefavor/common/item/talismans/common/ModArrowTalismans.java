...
import aurocosh.divinefavor.common.item.talismans.arrow.SpellNetherSwap;
...
public class ModArrowTalismans {
    ...
    public static void preInit() {
        ...
        nether_swap = ModRegistries.items.register(new ItemArrowTalisman("nether_swap", 10, new SpellNetherSwap(), Color.yellow.getRGB(), false, ArrowType.SPELL_ARROW));
