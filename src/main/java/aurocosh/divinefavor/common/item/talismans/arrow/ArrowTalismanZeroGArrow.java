...
public class ArrowTalismanZeroGArrow extends ItemArrowTalisman {
    public ArrowTalismanZeroGArrow(String name, ModSpirit spirit, int favorCost, Color color, double arrowDamage, EnumSet<ArrowOptions> options, ArrowType arrowType) {
