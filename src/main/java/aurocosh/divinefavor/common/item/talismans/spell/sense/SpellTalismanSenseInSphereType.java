...
public class SpellTalismanSenseInSphereType extends SpellTalismanSenseInSphere {
    public SpellTalismanSenseInSphereType(String name, ModSpirit spirit, EnumSet<SpellOptions> options, Color3f color3f, SenseConfig senseConfig, SenseBlockPredicate predicate) {
        super(name, spirit, options, color3f, senseConfig, predicate);
