...
public final class ModSpellTalismans {
    ...
    public static void preInit() {
        ...
        ice_bubble = new SpellTalismanReplacmentBubble("ice_bubble", ModSpirits.blizrabi, ConfigSpells.iceBubble, Blocks.AIR, Blocks.ICE, UtilPredicate.Companion.or(UtilBlock::isWater, UtilBlock::isIce));
        ...
        obsidian_bubble = new SpellTalismanReplacmentBubble("obsidian_bubble", ModSpirits.blizrabi, ConfigSpells.obsidianBubble, Blocks.AIR, Blocks.OBSIDIAN, UtilPredicate.Companion.or(UtilBlock::isLava, block -> block == Blocks.OBSIDIAN));
