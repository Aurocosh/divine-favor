...
import aurocosh.divinefavor.common.item.talismans.spell.highlighters.SpellTalismanHighlightBlockHeld;
import aurocosh.divinefavor.common.item.talismans.spell.highlighters.SpellTalismanHighlightBlockType;
...
public final class ModSpellTalismans {
    ...
    public static void preInit() {
        ...
        sense_block_approximate = new SpellTalismanHighlightBlockHeld("sense_block_approximate", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0.7f, 0.7f, 0), ConfigSpells.senseBlockApproximate);
        sense_block_close = new SpellTalismanHighlightBlockHeld("sense_block_close", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0, 0, 0.7f), ConfigSpells.senseBlockClose);
        sense_block_precise = new SpellTalismanHighlightBlockHeld("sense_block_precise", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0.7f, 0, 0), ConfigSpells.senseBlockPrecise);
        sense_block_vague = new SpellTalismanHighlightBlockHeld("sense_block_vague", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0, 0.7f, 0), ConfigSpells.senseBlockVague);
        sense_lava = new SpellTalismanHighlightBlockType("sense_lava", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0.9f, 0.2f, 0f), ConfigSpells.senseLava, SenseBlockPredicate.LAVA);
        sense_liquid = new SpellTalismanHighlightBlockType("sense_liquid", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0.7f, 0.2f, 0.7f), ConfigSpells.senseLiquid, SenseBlockPredicate.LIQUID);
        sense_ore_approximate = new SpellTalismanHighlightBlockType("sense_ore_approximate", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0.7f, 0.7f, 0), ConfigSpells.senseOreApproximate, SenseBlockPredicate.ORE);
        sense_ore_close = new SpellTalismanHighlightBlockType("sense_ore_close", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0, 0, 0.7f), ConfigSpells.senseOreClose, SenseBlockPredicate.ORE);
        sense_ore_precise = new SpellTalismanHighlightBlockType("sense_ore_precise", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0.7f, 0, 0), ConfigSpells.senseOrePrecise, SenseBlockPredicate.ORE);
        sense_ore_vague = new SpellTalismanHighlightBlockType("sense_ore_vague", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0, 0.7f, 0), ConfigSpells.senseOreVague, SenseBlockPredicate.ORE);
        sense_water = new SpellTalismanHighlightBlockType("sense_water", ModSpirits.romol, SpellOptions.RIGHT_CAST, new Color3f(0, 0.2f, 0.9f), ConfigSpells.senseWater, SenseBlockPredicate.WATER);
