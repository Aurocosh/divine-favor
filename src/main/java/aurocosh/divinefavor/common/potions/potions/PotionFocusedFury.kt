...
class PotionFocusedFury : ModPotion("focused_fury", true, 0x7FB8A4) {
    ...
    override fun renderCustomInvText(x: Int, y: Int, effect: PotionEffect, mc: Minecraft) {
        ...
        val furyData = PlayerData.get(player).focusedFuryData
    ...
    override fun onPotionRemoved(livingBase: EntityLivingBase) {
        ...
        val furyData = PlayerData.get(livingBase).focusedFuryData
        furyData.reset()
    ...
    companion object {
        ...
        fun onEntityDamaged(event: LivingDamageEvent) {
            ...
            val furyData = PlayerData.get(entity).focusedFuryData
            if (!furyData.hasFury())
                return
        ...
        fun onMobDeath(event: LivingDeathEvent) {
            ...
            val furyData = PlayerData.get(attacker).focusedFuryData
            if (furyData.hasFury())
                return
