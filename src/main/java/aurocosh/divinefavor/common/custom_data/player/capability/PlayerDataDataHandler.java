...
public class PlayerDataDataHandler {
    ...
    public static final Capability<IPlayerDataHandler> CAPABILITY_PLAYER_DATA = null;

    // Handles all of the required registration for the capability.
    public static void register() {
        CapabilityManager.INSTANCE.register(IPlayerDataHandler.class, new PlayerDataStorage(), DefaultPlayerDataHandler.class);
