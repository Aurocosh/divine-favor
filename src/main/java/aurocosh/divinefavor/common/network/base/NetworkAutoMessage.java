...
public abstract class NetworkAutoMessage<REQ extends NetworkAutoMessage> implements IMessage, IMessageHandler<REQ, IMessage> {
    ...
    static {
        ...
        writers.put(Vec3d.class, (BufWriter<Vec3d>) NetworkSerializers::writeVec3d);
        writers.put(Color3f.class, (BufWriter<Color3f>) NetworkSerializers::writeColor3f);
        writers.put(int[].class, (BufWriter<int[]>) NetworkSerializers::writeIntArray);
    }
    ...
    static {
        ...
        readers.put(Vec3d.class, (BufReader<Vec3d>) NetworkSerializers::readVec3d);
        readers.put(Color3f.class, (BufReader<Color3f>) NetworkSerializers::readColor3f);
        readers.put(int[].class, (BufReader<int[]>) NetworkSerializers::readIntArray);
    }
