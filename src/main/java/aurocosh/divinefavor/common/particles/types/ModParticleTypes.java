...
import aurocosh.divinefavor.common.particles.particles.ParticleStatic;
...
public final class ModParticleTypes {
    ...
    public static ParticleType particleStatic;
    ...
    public static void preInit() {
        ...
        particleStatic = ParticleHandler.register(new ParticleManager<>(new ParticleRenderer<>(new ResourceLocation(ConstResources.TEX_PARTICLES)), new ParticleStatic.ParticleStaticactory()));
    }
}