package aurocosh.divinefavor.client.models.rope.base

import net.minecraft.client.model.ModelBase
import net.minecraft.client.model.ModelRenderer
import net.minecraft.entity.Entity

class ModelRopeNode : ModelBase() {
    var renderer: ModelRenderer

    init {
        textureWidth = 64
        textureHeight = 64 //height is 64 here because block's texture must be 64x64
        renderer = ModelRenderer(this, 0, 5)
        renderer.setRotationPoint(0f, 0f, 0f)
        renderer.addBox(-1.0f, -1.0f, -1.0f, 2, 2, 2, 0.0f)
